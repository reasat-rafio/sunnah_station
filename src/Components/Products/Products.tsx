...
export const Products: React.FC<N_Deals_PageProps> = ({ products }) => {
   ...
   const [displayProrducts, setDisplayProducts] = useState([]);
               ...
               (
                  ...
                  return (
                     <motion.div
                        ...
                        className={`rounded-xl md:h-80  text-center hover:shadow-2xl  transition-all duration-150  my-6 flex flex-col  relative col-span-6 md:col-span-4 xl:col-span-3 ${
                           pgWidth == "sm" && "h-smCard"
                        } ${pgWidth == "xs" && "h-smCard"}`}
