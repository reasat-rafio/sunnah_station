...
import { TabVariants } from "../../../../utils/motion/animation";
      ...
      <div className="w-full  border-t  ">
        <ul className="  container m-auto flex justify-center items-center gap-12 font-nav lg:font-semibold  font-medium text-lg  border-b">
          ...
          <li
            ...
            className={`py-5 cursor-pointer relative  ${
              tab === "delivery_process" ? "text-gray-800" : "text-gray-500"
            }`}
          >
            <span className="lg:block text-lg hidden">DELIVERY PROCESS</span>
            <span className="block lg:hidden">
              <Process />
            </span>
            <AnimatePresence exitBeforeEnter>
          ...
          >
            <span className="lg:block text-lg hidden">RETURN & REFUND</span>
            <span className="block lg:hidden">
              <Return />
            </span>
            <AnimatePresence exitBeforeEnter>
